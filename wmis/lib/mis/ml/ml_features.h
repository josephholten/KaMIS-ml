...
class ml_features {
public:
    static constexpr int FEATURE_NUM = 16;
...
private:
    ...
    enum feature : int { NODES=0, EDGES=1, DEG=2, CHI2_DEG=3, AVG_CHI2_DEG=4, LCC=5, CHI2_LCC=6, CHROMATIC=7, T_WEIGHT=8, NODE_W=9, W_DEG=10, CHI2_W_DEG=11, MAX_W=12, MIN_W=13, MAX_NEIGHBORHOOD_W=14, HT=15, FEATURE_NUM_ENUM=16 };
