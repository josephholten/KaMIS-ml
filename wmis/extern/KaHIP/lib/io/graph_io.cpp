...
int graph_io::writeGraphNodeWeighted(graph_access & G, std::string filename) {
        std::ofstream f(filename.c_str());
        return graph_io::writeGraphNodeWeighted(G, f);
}

int graph_io::writeGraphNodeWeighted(graph_access & G, std::ofstream & f) {
...
int graph_io::readGraphWeighted(graph_access & G, const std::string & filename, std::string &comments) {
        std::string line;
